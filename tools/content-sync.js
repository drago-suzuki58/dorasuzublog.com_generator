...
const REPO = process.env.CONTENT_REPO_URL || pkg.config?.contentRepo;
const BRANCH = process.env.CONTENT_REPO_BRANCH || pkg.config?.contentBranch || 'main';
const DIR = process.env.CONTENT_REPO_DIR || pkg.config?.contentDir || 'source';
